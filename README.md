...
The project's website is <http://edadma.github.io/funl/> where you will find documentation and download instructions so that you can get a binary executable of the interpreter.
